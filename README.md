...
Version 3.0.0+ has undergone a TON of changes from the original fork (version 2.0), and the majority of method/functions have been changed.  You can find the latest release of version 2 on the [2.1.x branch](https://github.com/kelter-antunes/WifiWizard2/tree/2.1.x)
...
**If you are an iOS developer, please consider helping us to resolve the [open iOS issues](https://github.com/kelter-antunes/WifiWizard2/issues/6)**

**If you are an Android developer, please consider helping us to [refactor the current code base](https://github.com/kelter-antunes/WifiWizard2/issues/28)**
...
[https://github.com/kelter-antunes/WifiWizard2Demo](https://github.com/kelter-antunes/WifiWizard2Demo)
...
Run ```cordova plugin add https://github.com/kelter-antunes/WifiWizard2```
...
```cordova plugin add https://github.com/kelter-antunes/WifiWizard2#v3.1.1```

Find available tags here:
https://github.com/kelter-antunes/WifiWizard2/tags
...
See issue [#69](https://github.com/kelter-antunes/WifiWizard2/issues/69) regarding this
...
- Fixed `Object cannot be converted to int` in Android code (props @kelter-antunes)
- Props to @arsenal942 @jack828 @kelter-antunes @saoron for contributions
...
- Only return `false` in [Cordova Android](https://cordova.apache.org/docs/en/latest/guide/platforms/android/plugin.html) `execute` when invalid action is called
 [Issue #1](https://github.com/kelter-antunes/WifiWizard2/issues/1)
