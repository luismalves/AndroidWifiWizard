...
var WifiWizard2 = {
  ...
  remove: function (SSID, algorithm) {
    return new Promise(function (resolve, reject) {
      cordova.exec(resolve, reject, "WifiWizard2", "remove", [
  ...
  connect: function (SSID, bindAll, password, algorithm, isHiddenSSID) {
    return new Promise(function (resolve, reject) {
      ...
      cordova.exec(resolve, reject, "WifiWizard2", "connect", [
        WifiWizard2.formatWifiString(SSID),
        bindAll,
      ]);
      ...
      //     console.log("Entering specifier connection action via JS call ...");
      //     cordova.exec(resolve, reject, "WifiWizard2", "connect", [
      //       WifiWizard2.formatWifiString(SSID),
      //       password || "",
      //       algorithm || "",
      ...
      //     WifiWizard2.add(wifiConfig)
      //       .then(function (newNetID) {
  ...
  disconnect: function (SSID, algorithm) {
    return new Promise(function (resolve, reject) {
      if (SSID) {
        cordova.exec(resolve, reject, "WifiWizard2", "disconnectNetwork", [
          WifiWizard2.formatWifiString(SSID),
          algorithm || "",
        ]);
      } else {
  ...
  enable: function (SSID, bindAll, waitForConnection, algorithm) {
    return new Promise(function (resolve, reject) {
      ...
      cordova.exec(resolve, reject, "WifiWizard2", "enable", [
        WifiWizard2.formatWifiString(SSID),
        bindAll,
        waitForConnection,
        algorithm || "",
  ...
  disable: function (SSID, algorithm) {
    return new Promise(function (resolve, reject) {
      cordova.exec(resolve, reject, "WifiWizard2", "disable", [
        WifiWizard2.formatWifiString(SSID),
        algorithm || "",
      ]);
    });
  ...
  getSSIDNetworkID: function (SSID, algorithm) {
    return new Promise(function (resolve, reject) {
      cordova.exec(resolve, reject, "WifiWizard2", "getSSIDNetworkID", [
        WifiWizard2.formatWifiString(SSID),
        algorithm || "",
      ]);
    });
