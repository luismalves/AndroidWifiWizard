...
public class WifiWizard2 extends CordovaPlugin {
     ...
     * password has been supplied. The checks correspond to WEP40, WEP104 &
     * WEP232
     */
...
//            });
    ...
    private boolean add(CallbackContext callbackContext, JSONArray data) {
        ...
        try {
            ...
            if (authType.equals("WPA") || authType.equals("WPA2")) {
                ...
                /**
                 * OPEN Network data format: 0: ssid 1: auth 2: <not used>
                 * 3: isHiddenSSID
                 */
                wifi.SSID = newSSID;
                wifi.allowedKeyManagement.set(WifiConfiguration.KeyMgmt.NONE);
    ...
    /**
     * This method will check if WiFi is enabled, and enable it if not, waiting
     * up to 10 seconds for it to enable
     *
     ...
     *
     * This method unregisters the network changed receiver, as well as setting
     * null for bindProcessToNetwork or setProcessDefaultNetwork to prevent
     * future sockets from application being routed through Wifi.
     */
     ...
     * action, and confirming that we are in fact connected to wifi, and the
     * wifi we're connected to, is the correct network set in enable, or
     * connect.
     */
